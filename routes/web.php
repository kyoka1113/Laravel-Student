...
//学生削除処理
Route::post('students/delete/{id}', DeleteStudentController::class)->name('students.delete');
//成績検索処理
Route::get('/grades/search/{id}', SearchGradeController::class)->name('grades.search');
//成績編集画面を表示
Route::get('/editgrades/{id}', EditGradeController::class)->name('editgrades.edit');
//成績編集処理
Route::post('/editgrades/{id}',UpdateEditGradeController::class)->name('editgrades.update');
//成績登録画面を表示
Route::get('/grades/create/{id}', ShowGradeRegistrationController::class)->name('grades.create');
//成績登録処理
Route::post('/grades/store/{id}', StoreGradeRegistrationController::class)->name('grades.store');
//学生編集画面表示
